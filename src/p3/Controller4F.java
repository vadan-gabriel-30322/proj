...
public class Controller4F {
    ...
    public static void main(String[] args) {
        ...
        pn.NetworkPort = 1082; // Different port to avoid conflict if running simultaneously with others? Or
                               // same?
        // Controller2F uses 1081. Lanes_Intersection uses 1080.
        // I'll use 1082 for Controller4F to be safe, though usually only one controller
        // runs at a time.
