...
public class BusStation {
    public static void main(String[] args) {
        ...
        // T_S: P_x1 -> P_Station (Only Buses that want to enter)
        ...
        t_o.TransitionName = "T_o"; // Not explicitly named in text but implied "not all passing buses go to
                                    // station"
        t_o.InputPlaceName.add("P_x1");

        Condition ToCt1 = new Condition(t_o, "P_x1", TransitionCondition.HaveCar); // Any car
        ...
        Condition TesCt1 = new Condition(t_es, "P_Station", TransitionCondition.HaveCar); // HaveCarForMe?
        ...
        t_es.Delay = 1; // Station stop time?
