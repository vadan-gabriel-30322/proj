...
public class BusLaneIntersection {
    public static void main(String[] args) {

        PetriNet pn = new PetriNet();
        pn.PetriNetName = "Bus Lane Intersection";
        ...
        Condition T1Ct3 = new Condition(t1, "P_a1", TransitionCondition.IsPriority); // Check for Priority/Bus
        ...
        // T1_Normal (For normal cars in Bus Lane? Maybe not allowed? Assuming only
        // priority cars allowed)
        // If normal cars are allowed but don't get priority, we need another
        // transition.
        // But "Bus Lane" usually means ONLY buses/priority.
        // I will assume only priority cars can enter P_x1.
        ...
        // T_in (Priority Exit - Bypasses Traffic Light)
        ...
        System.out.println("Bus Lane Intersection started \n ------------------------------");
        pn.Delay = 2000;
        // pn.Start();
