...
public class Exercise2 {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        pn.PetriNetName = "HTC PI Controller (Exercise 2)";
        pn.NetworkPort = 1083;
        pn.SetInputFile("C:\\Users\\vadan\\Desktop\\DCS\\All_Petri_FW\\PetriInputData\\HTC.txt");

        // ... (Same FLRS definitions as HTC.java) ...
        ...
        System.out.println("HTC PI Controller (Exercise 2) started");
        pn.Delay = 500;
