...
public class RTC {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        pn.PetriNetName = "RTC";
        pn.NetworkPort = 1082;
        pn.SetInputFile("C:\\Users\\vadan\\Desktop\\DCS\\All_Petri_FW\\PetriInputData\\RTC.txt");
        ...
        FLRS t3Table = new FLRS(new FV(FZ.FF, FZ.ZR), new FV(FZ.FF, FZ.FF), new FV(FZ.FF, FZ.FF), new FV(FZ.FF, FZ.FF),
                new FV(FZ.ZR, FZ.FF));
        ...
        u.SetName("u");
        u.Value = new TransferOperation("localhost", "1081", "u");
        pn.PlaceList.add(u);
        ...
        System.out.println("RTC started \n ------------------------------");
        pn.Delay = 500;
