...
public class Lanes_Intersection {
    public static void main(String[] args) {
        ...
        DataString bus = new DataString();
        bus.SetName("bus");
        bus.SetValue("bus");
        pn.ConstantPlaceList.add(bus);
        ...
        grdTs1.Activations.add(new Activation(ts1, "bus", TransitionOperation.SendOverNetwork, "OP1"));
        ...
        grdTs2.Activations.add(new Activation(ts2, "bus", TransitionOperation.SendOverNetwork, "OP2"));
        ...
        grdTs3.Activations.add(new Activation(ts3, "bus", TransitionOperation.SendOverNetwork, "OP3"));
        ...
        grdTs4.Activations.add(new Activation(ts4, "bus", TransitionOperation.SendOverNetwork, "OP4"));
        ...
        InputCar inputCar = new InputCar(pn);
