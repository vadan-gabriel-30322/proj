...
public class Controller_Dynamic {

    public static void main(String[] args) {
        PetriNet pn = new PetriNet();
        pn.PetriNetName = "Controller Dynamic";
        pn.SetName("Controller Dynamic");
        pn.NetworkPort = 1082;
        ...
        System.out.println("Controller Dynamic started \n ------------------------------");
        pn.Delay = 300;
        // pn.Start();
    ...
    private static void addGuard(PetriTransition tf, PetriTransition t2, PetriTransition t4, PetriTransition t6,
        ...
        // Also need to consume pf? The user example doesn't show consuming pf, but it
        // says "t1 also moves the token to pf".
        // If tf doesn't consume pf, it might fire infinitely?
        // "tf that has the subguards... check in all of them if pf not null"
        // Usually transitions consume tokens from input places.
        // If pf is an input place, it will be consumed by default unless we use
        // TransitionOperation.PopElementWithoutTarget?
        // Wait, standard Petri Net behavior is to consume tokens.
        // The user example shows: t2.InputPlaceName.add("pf");
        // So it will consume pf.
