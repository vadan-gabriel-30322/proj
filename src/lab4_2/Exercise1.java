...
public class Exercise1 {
        public static void main(String[] args) throws FileNotFoundException {
                ...
                pn.PetriNetName = "HTC Optimized (Exercise 1)";
                pn.NetworkPort = 1083;
                ...
                // OPTIMIZATION: Changed weight of P4 from 1.2F to 1.0F
                input4.add(new PlaceNameWithWeight("P4", 1.0F));
                ...
                System.out.println("HTC Optimized (Exercise 1) started");
                pn.Delay = 500;
