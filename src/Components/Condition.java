		...
		switch (condition) {
			...
			case IsBus: {
				...
				if (Value1.GetType() == PetriObjectType.DataCar) {
					Car car = (Car) Value1.GetValue();
					if (car.Model.equals("Bus")) {
						return true;
					}
				}
				break;
			...
			case IsPriority: {
				...
				if (Value1.GetType() == PetriObjectType.DataCar) {
					Car car = (Car) Value1.GetValue();
					if (car.Model.equals("Priority") || car.Model.equals("Bus") || car.Model.equals("Taxi")) {
						return true;
					}
				}
				break;
			...
			case HavePriorityCar: {
				...
				if (Value1.GetValue() == null)
					return false;
				if (Value1.GetType() == PetriObjectType.DataCarQueue) {
					if (util.HavePriorityCar(((CarQueue) Value1.GetValue()).Cars)) {
						return true;
					}
				}
				break;
			...
			case HaveBus: {
				...
				if (Value1.GetValue() == null)
					return false;
				if (Value1.GetType() == PetriObjectType.DataCarQueue) {
					if (util.HaveBus(((CarQueue) Value1.GetValue()).Cars)) {
						return true;
					}
				}
				break;
			...
			case HaveTaxi: {
				...
				if (Value1.GetValue() == null)
					return false;
				if (Value1.GetType() == PetriObjectType.DataCarQueue) {
					if (util.HaveTaxi(((CarQueue) Value1.GetValue()).Cars)) {
						return true;
					}
				}
				break;
