...
public class Intersection1 {
    public static void main(String[] args) {
        ...
        pn.PetriNetName = "Intersection 1 (Crossroads)";
        pn.NetworkPort = 1081; // Unique port for Intersection 1
        ...
        // Controller 1 Input Sensor 1
        DataTransfer op1 = new DataTransfer();
        op1.SetName("OP1");
        op1.Value = new TransferOperation("localhost", "1091", "in1"); // Controller 1 Port 1091
        ...
        // T1 ------------------------------------------------
        // Modified for Bus Lane: Checks IsPriority
        ...
        Condition T1Ct3 = new Condition(t1, "P_a1", TransitionCondition.IsPriority);
        ...
        ts1.InputPlaceName.add("P_a1");
        ts1.IsAsync = true;

        Condition Ts1Ct1 = new Condition(ts1, "P_x1", TransitionCondition.CanNotAddCars);
        Condition Ts1Ct2 = new Condition(ts1, "P_a1", TransitionCondition.NotNull);
        Ts1Ct1.SetNextCondition(LogicConnector.AND, Ts1Ct2);

        GuardMapping grdTs1 = new GuardMapping();
        grdTs1.condition = Ts1Ct1;
        grdTs1.Activations.add(new Activation(ts1, "green", TransitionOperation.SendOverNetwork, "OP1")); // Send signal
                                                                                                          // to
                                                                                                          // controller
        ts1.GuardMappingList.add(grdTs1);

        ts1.Delay = 10; // Avoid spamming
        pn.Transitions.add(ts1);

        // T2 ------------------------------------------------
        // Normal Green Light Exit
        ...
        // T_in (Priority Exit - Bypasses Traffic Light for Lane 1)
        PetriTransition t_in = new PetriTransition(pn);
        t_in.TransitionName = "T_in";
        t_in.InputPlaceName.add("P_x1");

        Condition TinCt1 = new Condition(t_in, "P_x1", TransitionCondition.HavePriorityCar);

        GuardMapping grdTin = new GuardMapping();
        grdTin.condition = TinCt1;
        grdTin.Activations.add(new Activation(t_in, "P_x1", TransitionOperation.PopElementWithoutTarget, "P_b1"));
        ...
        ts4.TransitionName = "T_s4";
        ts4.InputPlaceName.add("P_x4");
        ts4.IsAsync = true;

        Condition Ts4Ct1 = new Condition(ts4, "P_x4", TransitionCondition.HaveCar);
        Condition Ts4Ct2 = new Condition(ts4, "OP4", TransitionCondition.NotNull);
        Ts4Ct1.SetNextCondition(LogicConnector.AND, Ts4Ct2);

        GuardMapping grdTs4 = new GuardMapping();
        grdTs4.condition = Ts4Ct1;
        grdTs4.Activations.add(new Activation(ts4, "P_x4", TransitionOperation.PopElementWithoutTargetToQueue, "P_x4"));
        grdTs4.Activations.add(new Activation(ts4, "green", TransitionOperation.SendOverNetwork, "OP4"));
        ...
        grdT19.Activations.add(new Activation(t19, "P_b4", TransitionOperation.AddElement, "P_I"));
        ...
        System.out.println("Intersection 1 (Crossroads) started \n ------------------------------");
        pn.Delay = 2000;
