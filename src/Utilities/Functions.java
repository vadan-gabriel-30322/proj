...
public class Functions implements Serializable {
	...
	public boolean HavePriorityCar(ArrayList<DataCar> list) {
		if (list == null)
			return false;
		for (int i = 0; i < list.size(); i++) {
			if (list.get(i) != null && list.get(i).Value != null) {
				String model = list.get(i).Value.Model;
				if (model.equals("Priority") || model.equals("Bus") || model.equals("Taxi")) {
					return true;
				}
			}
		}
	...
	public boolean HaveBus(ArrayList<DataCar> list) {
		if (list == null)
			return false;
		for (int i = 0; i < list.size(); i++) {
			if (list.get(i) != null && list.get(i).Value != null) {
	...
	public boolean HaveTaxi(ArrayList<DataCar> list) {
		if (list == null)
			return false;
		for (int i = 0; i < list.size(); i++) {
			if (list.get(i) != null && list.get(i).Value != null) {
				String model = list.get(i).Value.Model;
				if (model.equals("Taxi")) {
					return true;
				}
			}
		}
